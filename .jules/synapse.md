...
**Coupling approach:** Loosely coupled via `log_event()` injection in `backend/api/auth.py`. Auth passes contextual data without needing to know how Audit stores or processes it.
