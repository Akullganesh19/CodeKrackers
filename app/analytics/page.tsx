                      ...
                      {heatMapData.map((d, i) => (
                        <tr key={i} className="group hover:bg-white/[0.01]">
                          ...
                          <td className="px-10 py-6 text-right">
                            <span className={`font-space font-bold ${d.status === 'HIGH' ? 'text-danger' : d.status === 'MEDIUM' ? 'text-warning' : 'text-success'}`}>
            ...
            <div className="vsdp-card p-10 space-y-10">
               ...
               <div className="flex flex-col items-center gap-12 py-6">
                 ...
                 <div className="grid grid-cols-2 gap-8 w-full">
                    <LegendItem label="Smishing" color="bg-accent" val="52%" />
                    <LegendItem label="Vishing" color="bg-danger" val="38%" />
                    <LegendItem label="Social Eng" color="bg-warning" val="10%" />
                 </div>
               </div>
            </div>
