...
export default function SMSScannerPage() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const cachedResponse = getScanResult(text);
      const response = cachedResponse
        ? (await cachedResponse as Response)
        : await fetch('http://localhost:8000/api/analytics/scan', {
            method: 'POST',
            headers: {
          ...
          <div className="vsdp-card max-w-[700px] mx-auto overflow-hidden">
            <div className="p-8 space-y-6">
              ...
              <div className="relative group">
                <textarea
                  value={text}
                  onChange={(e) => { setText(e.target.value); preComputeScan(e.target.value); }}
