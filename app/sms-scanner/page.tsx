...
export default function SMSScannerPage() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await Oracle.getScanResult('http://localhost:8000/api/analytics/scan', {
        method: 'POST',
        headers: { 
              ...
              <div className="relative group">
                <textarea
                  ...
                  onChange={(e) => {
                    ...
                    // Oracle Prediction: When user types/pastes enough text, predictively pre-compute the scan result
