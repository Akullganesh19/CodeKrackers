...
from backend.models.orm import FIR, Threat, User, Blacklist, BlacklistType, ThreatType, ThreatSeverity  # noqa: E501
...
async def get_dashboard_summary(
    ...
    total_users = (await db.execute(select(func.count(User.id)).filter(User.is_active == True))).scalar() or 0  # noqa: E501
