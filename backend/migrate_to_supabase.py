...
def migrate():
    ...
    try:
        ...
        db_type = "SQLite" if "sqlite" in settings.DATABASE_URL else "PostgreSQL/Supabase"
...
if __name__ == "__main__":
    if "[PASSWORD]" in settings.DATABASE_URL:
        print("⚠️  Please update your DATABASE_URL in .env with your actual Supabase credentials first.")
    else:
        migrate()
