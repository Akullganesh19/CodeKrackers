...
from sqlalchemy import Column, Integer, String, DateTime, Text, JSON, Index  # noqa: E501,F401
...
class AuditLog(Base):
    ...
    # What
    action = Column(String(64), nullable=False, index=True)  # LOGIN_SUCCESS, THREAT_CREATED, FIR_GENERATED, etc.  # noqa: E501
