...
class ChildProfile(TimestampMixin, Base):
    ...
    # Lock mode
    lock_mode = Column(
        Enum(ChildLockMode), default=ChildLockMode.FILTERED, nullable=False
    )
    ...
    __table_args__ = (Index("ix_child_parent_active", "parent_id", "is_active"),)
