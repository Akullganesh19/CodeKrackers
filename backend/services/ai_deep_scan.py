...
def _groq_scan(content: str, source_type: str) -> Dict[str, Any]:
...
def ai_deep_scan(content: str, source_type: str = "sms") -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(f"Ollama unavailable or failed ({e}), falling back to Groq Cloud...")
    ...
    try:
        return _groq_scan(content, source_type)
    except Exception as e:
