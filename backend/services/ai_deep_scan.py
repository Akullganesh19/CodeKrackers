...
@with_retries(max_attempts=3, base_delay=0.5, max_delay=3.0)
def _call_groq(prompt: str) -> Any:
    """
    Internal helper to call Groq API with resilience mechanisms.
    """
...
def ai_deep_scan(content: str, source_type: str = "sms") -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(f"Ollama failed or unreachable: {e}. Falling back to Groq Cloud...")
