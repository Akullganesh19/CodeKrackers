...
groq_breaker = CircuitBreaker(failure_threshold=3, recovery_timeout=60.0)
...
def ai_deep_scan(content: str, source_type: str = "sms") -> Dict[str, Any]:
    ...
    try:
        result = groq_breaker.call(call_groq_api, prompt)
        ...
        return {"score_increase": 0.0, "reason": f"AI Scan failed/bypassed: {e}"}
