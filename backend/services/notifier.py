...
def send_threat_alert(phone_number: str, threat_type: str, score: float, original_sender: str):
    ...
    try:
        ...
        message = send_twilio_message(client, body=alert_msg, from_=settings.TWILIO_PHONE_NUMBER, to=phone_number)
...
def send_otp(phone_number: str) -> str:
    ...
    try:
        ...
        send_twilio_message(client, body=msg_body, from_=settings.TWILIO_PHONE_NUMBER, to=phone_number)
