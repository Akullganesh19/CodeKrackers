...
@with_retries(max_attempts=3, base_delay=0.5, max_delay=2.0)
def _call_ollama(payload: dict) -> requests.Response:
...
def ollama_deep_scan(content: str, source_type: str = "sms") -> Dict[str, Any]:
    ...
    # Let exceptions propagate up so callers know to fallback
