...
def test_mass_assignment_privilege_escalation():
    ...
    payload = {"email": unique_email, "password": "Password1!", "role": "admin"}
    ...
    login_payload = {"email": unique_email, "password": "Password1!"}
...
def test_otp_role_escalation():
    send_payload = {"identifier": "otp_hacker@example.com", "role": "admin"}
